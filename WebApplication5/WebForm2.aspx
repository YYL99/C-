...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:RadioButton ID="RadioButton1" runat="server" GroupName="Group1" Text="男" OnCheckedChanged="RadioButton1_CheckedChanged" ></asp:RadioButton>
    ...
    <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">购物>></asp:LinkButton>
</asp:Content>
